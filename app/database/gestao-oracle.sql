...
CREATE OR REPLACE TRIGGER customers_id_seq_tr 
...
CREATE OR REPLACE TRIGGER quote_id_seq_tr 

BEFORE INSERT ON quote FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT quote_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
...
CREATE OR REPLACE TRIGGER service_id_seq_tr 
...
END;
CREATE SEQUENCE service_requirement_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER service_requirement_id_seq_tr 

BEFORE INSERT ON service_requirement FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT service_requirement_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
...
END;
CREATE SEQUENCE status_quote_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER status_quote_id_seq_tr 

BEFORE INSERT ON status_quote FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT status_quote_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
...
END;
CREATE SEQUENCE type_product_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER type_product_id_seq_tr 

BEFORE INSERT ON type_product FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT type_product_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 

END;
CREATE SEQUENCE type_service_id_seq START WITH 1 INCREMENT BY 1; 

CREATE OR REPLACE TRIGGER type_service_id_seq_tr 

BEFORE INSERT ON type_service FOR EACH ROW 
    ...
    BEGIN 
        ...
        SELECT type_service_id_seq.NEXTVAL INTO :NEW.id FROM DUAL; 
