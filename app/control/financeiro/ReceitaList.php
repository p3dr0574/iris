...
class ReceitaList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $categoria_id = new TDBCombo('categoria_id', 'gestao', 'Categoria', 'id', '{descricao}','descricao asc' , $criteria_categoria_id );
        $conta_id = new TDBCombo('conta_id', 'gestao', 'Conta', 'id', '{descricao}','descricao asc' , $criteria_conta_id );
        $status_lancamento_id = new TDBCombo('status_lancamento_id', 'gestao', 'StatusLancamento', 'id', '{descricao}','id asc' , $criteria_status_lancamento_id );
