...
class CategoriaHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $tipo_categoria_id = new TDBCombo('tipo_categoria_id', 'gestao', 'TipoCategoria', 'id', '{descricao}','id asc' , $criteria_tipo_categoria_id );
        $totaliza_receita_despesa_id = new TDBCombo('totaliza_receita_despesa_id', 'gestao', 'TotalizaReceitaDespesa', 'id', '{descricao}','id asc' , $criteria_totaliza_receita_despesa_id );
