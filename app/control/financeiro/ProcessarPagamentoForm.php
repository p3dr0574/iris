...
class ProcessarPagamentoForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_ProcessarPagamentoForm';
    ...
    public function __construct( $param = null)
    {
        ...
        $this->form->setFormTitle("Pagamento de Despesa em Lote");

        $criteria_lancamentos = new TCriteria();

        $filterVar = TSession::getValue('DespesaListbuilder_datagrid_check');
        ...
        $lancamentos->setValue(TSession::getValue('DespesaListbuilder_datagrid_check'));
        ...
        $lancamentos->fillWith('gestao', 'Lancamento', 'id', 'descricao asc' , $criteria_lancamentos);


        $row1 = $this->form->addFields([new TLabel("Data do Pagamento:", null, '14px', null, '100%'),$data_pagamento],[]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ProcessarPagamentoForm]');
    ...
    public function onProcessar($param = null) 
    {
        try
        {
              ...
              if($data->lancamentos){
                 ...
                 TToast::show("success", "Despesas Pagas com sucesso!", "topRight", "fas:check-square");
