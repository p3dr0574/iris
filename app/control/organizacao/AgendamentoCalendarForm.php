...
class AgendamentoCalendarForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $plano_id = new TDBCombo('plano_id', 'gestao', 'Plano', 'id', '{descricao}','descricao asc' , $criteria_plano_id );
        $descricao = new TText('descricao');
        $relevancia_id = new TDBCombo('relevancia_id', 'gestao', 'Relevancia', 'id', '{descricao}','descricao asc' , $criteria_relevancia_id );
        $tipo_id = new TDBCombo('tipo_id', 'gestao', 'Tipo', 'id', '{descricao}','id asc' , $criteria_tipo_id );
        $recorrencia_id = new TDBCombo('recorrencia_id', 'gestao', 'Recorrencia', 'id', '{descricao}','id asc' , $criteria_recorrencia_id );
        $limite_recorrencia = new TDate('limite_recorrencia');
        $considera_final_semana_id = new TDBCombo('considera_final_semana_id', 'gestao', 'ConsideraFinalSemana', 'id', '{descricao}','descricao asc' , $criteria_considera_final_semana_id );
        $lembrete_agenda_id = new TDBCombo('lembrete_agenda_id', 'gestao', 'LembreteAgenda', 'id', '{descricao}','id asc' , $criteria_lembrete_agenda_id );
        $id = new TEntry('id');
